Shader "PetToon/Improved2/Body"
{
    Properties
    {
        ...
        _OutlineWidth("Outline width in pixels", Range(0,4)) = 1.4
        ...
        [Header(Original Mesh Inputs)]
        [Toggle] _UseUV1Backface("Use UV1 for back-face color", Float) = 0
        _UseVertexShadowBias("Use vertex color G shadow bias", Range(0,1)) = 0
        _ShadowRampWidth("Vertex shadow bias strength", Range(0,0.5)) = 0.1
    }
    SubShader
    {
