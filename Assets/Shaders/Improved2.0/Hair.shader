Shader "PetToon/Improved2/Hair"
{
    Properties
    {
        ...
        _ShadowPosition("Ramp shadow position", Range(0,1)) = 0.55
        _ShadowSoftness("Ramp shadow softness", Range(0.001,0.5)) = 0.08

        [Header(Fallback Cel Lighting)]
        _ShadowTint("Fallback shadow multiplier", Vector) = (0.62,0.65,0.75,1)
        _MidTint("Fallback middle multiplier", Vector) = (0.82,0.84,0.90,1)
        ...
        _OutlineWidth("Outline width in pixels", Range(0,4)) = 1.3
        ...
        _SpecIntensity("Small cel highlight intensity", Range(0,0.3)) = 0.035
        _SpecPower("Highlight sharpness", Range(1,128)) = 48

        [Header(Restrained Hair Highlight)]
        _HairHighlightColor("Hair highlight color", Color) = (0.8,0.7,0.85,1)
        _HairHighlightIntensity("Hair highlight intensity", Range(0,0.3)) = 0.045
        _HairHighlightExponent("Hair highlight sharpness", Range(1,256)) = 64
        _HairAnisoShift("Anisotropic shift", Range(-1,1)) = 0.1
    }
    SubShader
    {
