Shader "PetToon/Improved2/Tail"
{
    Properties
    {
        [MainColor] _BaseColor("Base color", Color) = (0.8,0.494,0.161,1)
        ...
        _ShadowPosition("Ramp shadow position", Range(0,1)) = 0.52
        _ShadowSoftness("Ramp shadow softness", Range(0.001,0.5)) = 0.14
        ...
        _OutlineWidth("Outline width in pixels", Range(0,4)) = 0.9
    }
    SubShader
    {
